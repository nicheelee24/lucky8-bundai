...
//if (isset($_GET["eid"])) {
   // $uid = $_GET["eid"];
//}
 $mongo = new MongoDB\Driver\Manager("mongodb+srv://nicheelee24:B0wrmtGcgtXKoXWN@cluster0.8yb8idj.mongodb.net/gms2024?retryWrites=true&w=majority&appName=Cluster0");
$filter = [];
 $options = [];
